...
const CountersClientPage = ({ opponentOptions }: CountersClientPageProps) => {
  ...
  const selectedOpponent = opponentOptions.find((o) => o.value === opponentSlug);
  ...
  const handleValueChange = (name?: string | null) => {
    ...
    const opponent = opponentOptions.find((o) => o.name === name);
    if (opponent) {
